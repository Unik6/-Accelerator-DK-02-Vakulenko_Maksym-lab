...
-- Source Path: lab2_float/CALC_MAG_AND_PHASE_FLoat_POIN/nfp_mul_single
-- Hierarchy Level: 1
-- 
...
ARCHITECTURE rtl OF nfp_mul_single IS
  ...
  SIGNAL Delay4_reg                       : vector_of_unsigned48(0 TO 2);  -- ufix48 [3]
  SIGNAL Delay4_reg_next                  : vector_of_unsigned48(0 TO 2);  -- ufix48 [3]
  ...
  SIGNAL Delay4_reg_1                     : vector_of_signed10(0 TO 3);  -- sfix10 [4]
  SIGNAL Delay4_reg_next_1                : vector_of_signed10(0 TO 3);  -- sfix10 [4]
...
BEGIN
  ...
  BEGIN
    IF reset = '1' THEN
      Delay3_out1_2 <= to_unsigned(0, 49);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
  ...
  Bit_Slice1_out1 <= Delay3_out1_2(48);
  ...
  Logical_Operator3_out1_1 <=  NOT Delay3_out1_3;
  ...
  Delay8_out1_1 <= Delay8_reg(3);
  Delay8_reg_next(0) <= Logical_Operator2_out1_1;
  ...
  Switch2_out1_1 <= Subtract2_out1 WHEN Delay3_out1_3 = '0' ELSE
      Constant4_out1_1;

  Delay4_3_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
      Delay4_reg_1(0) <= to_signed(16#000#, 10);
      Delay4_reg_1(1) <= to_signed(16#000#, 10);
      Delay4_reg_1(2) <= to_signed(16#000#, 10);
      Delay4_reg_1(3) <= to_signed(16#000#, 10);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
  ...
  Delay4_out1_3 <= Delay4_reg_1(3);
  Delay4_reg_next_1(0) <= Switch2_out1_1;
  ...
  Switch1_out1_3 <= Delay4_out1_3 WHEN Delay8_out1_1 = '0' ELSE
      Constant_out1_1;
  ...
  Bit_Shift_out1 <= Delay3_out1_2 srl 1;

  
  Switch_out1_3 <= Delay3_out1_2 WHEN Bit_Slice1_out1 = '0' ELSE
      Bit_Shift_out1;
  ...
  Add_out1_2 <= resize(resize(Bit_Slice1_out1_2, 32) + Add_add_cast_2, 24);
  ...
  Switch_out1_4 <= Delay2_out1_dtc WHEN Delay1_out1_2 = '0' ELSE
      Delay_out1_2;
